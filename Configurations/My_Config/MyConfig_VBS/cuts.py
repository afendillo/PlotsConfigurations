...
# cuts['VBS_13TeV_BaseCut_eMu']=BaseCut + '&& std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == 11*13' 
#cuts['VBS_13TeV_BaseCut_ee']=BaseCut + '&& std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == 11*11' 
# cuts['VBS_13TeV_BaseCut_eMu']=BaseCut + '&& std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == 11*13' 
#cuts['VBS_13TeV_BaseCut_MuMu']=BaseCut + '&& std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == 13*13' 
...
#cuts['VBS_13TeV_bVeto']=bVeto+softMuVeto

cuts['VBS_13TeV_bJetVeto']=bJetVeto

# bJetTag  = '!(' + bJetVeto + ')'  
#cuts['VBS_13TeV_bJetTag']=BaseCut + bJetTag
...
# cuts['VBS_13TeV_Zveto_LL']=BaseCut + zveto + '&& (std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == 11*11 || std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == 13*13)' 
# cuts['VBS_13TeV_Zveto_eMu']=BaseCut + zveto + '&& std_vector_lepton_flavour[0] * std_vector_lepton_flavour[1] == 11*13' 


# cuts['VBS_13TeV_Vetoes']  = mll0 + zveto + tauVeto + bJetVeto
